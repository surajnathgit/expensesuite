...
const features = [
  {
    ...
    title: 'OCR Receipt Scanning',
    description:
      'Automate receipt processing with advanced OCR technology for accurate categorization and instant data extraction.',
    gradient: '#3b82f6, #8b5cf6', // blue-500 to purple-600
  },
  {
    icon: <Security sx={{ width: 32, height: 32 }} />,
    title: 'Multi-level Approval',
    description:
      'Streamline approvals with customizable, multi-tiered workflows tailored to your organization’s structure.',
    gradient: '#8b5cf6, #ec4899', // purple-500 to pink-500
  },
  {
    icon: <FlashOn sx={{ width: 32, height: 32 }} />,
    title: 'Real-time Tracking',
    description:
      'Monitor expenses and budgets in real-time to maintain complete financial control and transparency.',
    gradient: '#ec4899, #ef4444', // pink-500 to red-500
  },
  {
    icon: <Group sx={{ width: 32, height: 32 }} />,
    title: 'Software Integration',
    description:
      'Seamlessly connect with popular accounting platforms for unified financial management across systems.',
  ...
  },
  {
    ...
    title: 'Mobile App Access',
    description:
      'Easily manage your expenses on-the-go with our intuitive mobile app, available for both iOS and Android devices.',
    gradient: '#f97316, #facc15', // orange-500 to yellow-400
  },
  {
    icon: <AccessTime sx={{ width: 32, height: 32 }} />,
    title: 'Automated Reports',
    description:
      'Generate comprehensive financial reports automatically with customizable templates and scheduling.',
    gradient: '#facc15, #10b981', // yellow-400 to green-500
  },
];
  ...
  return (
    <Box
      ...
      sx={{
        ...
        px: { xs: 2, sm: 3, lg: 4 },
        background: 'linear-gradient(to bottom right, #111827, #4c1d95, #111827)',
        color: 'white', // Ensures all children inherit white
        overflowX: 'hidden',
      }}
    >
      <Box sx={{ maxWidth: '1280px', mx: 'auto' }}>
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate={isInView ? 'visible' : 'hidden'} // fallback
        >
          <motion.div variants={itemVariants}>
            <Box sx={{ textAlign: 'center', mb: { xs: 8, md: 12 } }}>
              <Typography
