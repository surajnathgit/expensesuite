        ...
        <motion.div variants={containerVariants} initial="hidden" animate={controls}>
          ...
          <motion.div variants={itemVariants}>
            <Box textAlign="center" mb={{ xs: 4, md: 8 }}>
              ...
              >
                Discover how Expenses Suite transforms traditional expense management.
              </Typography>
              <Chip
                label="Expense Management Transformation"
                sx={{
                  background: `rgba(${parseInt(theme.palette.primary.main.slice(1, 3), 16)}, ${parseInt(theme.palette.primary.main.slice(3, 5), 16)}, ${parseInt(theme.palette.primary.main.slice(5, 7), 16)}, 0.1)`,
                  color: theme.palette.primary.light,
                  fontWeight: 'bold',
              ...
              <Grid item xs={12} md={6}>
                <StyledCard>
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Typography variant="subtitle1" sx={{ color: theme.palette.error.light, fontWeight: 'bold', mb: 1 }}>
                      Manual Expense Processing
                    </Typography>
                    <Typography variant="subtitle2" sx={{ color: 'white', opacity: 0.8, mb: 1 }}>
                      <strong>Current Challenges:</strong>
                    </Typography>
                    <ul style={{ paddingLeft: '1rem', color: 'white', opacity: 0.8 }}>
                      <li>Paper receipt submission and tracking</li>
                      <li>Manual expense categorization</li>
                      <li>Time-consuming approval workflows</li>
                      <li>Manual mileage calculations</li>
                      <li>Delayed reimbursement processing</li>
                      <li>Limited expense fraud detection</li>
                    </ul>
                    <Typography variant="subtitle2" sx={{ color: 'white', opacity: 0.8, mt: 2, mb: 1 }}>
                      <strong>Key Pain Points:</strong>
                    </Typography>
                    <ul style={{ paddingLeft: '1rem', color: 'white', opacity: 0.8 }}>
                      <li>High administrative overhead</li>
                      <li>Delayed expense reimbursements</li>
                      <li>Poor expense policy compliance</li>
                      <li>Limited expense visibility and control</li>
                    </ul>
                  </CardContent>
                </StyledCard>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <StyledCard>
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Typography variant="subtitle1" sx={{ color: theme.palette.success.light, fontWeight: 'bold', mb: 1 }}>
                      Automated Expense Ecosystem
                    </Typography>
                    <Typography variant="subtitle2" sx={{ color: 'white', opacity: 0.8, mb: 1 }}>
                      <strong>New Capabilities:</strong>
                    </Typography>
                    <ul style={{ paddingLeft: '1rem', color: 'white', opacity: 0.8 }}>
                      <li>Mobile receipt capture and processing</li>
                      <li>AI-powered expense categorization</li>
                      <li>Automated approval workflows</li>
                      <li>GPS-based mileage tracking</li>
                      <li>Instant reimbursement processing</li>
                      <li>Advanced fraud detection and prevention</li>
                    </ul>
                    <Typography variant="subtitle2" sx={{ color: 'white', opacity: 0.8, mt: 2, mb: 1 }}>
                      <strong>Achieved Improvements:</strong>
                    </Typography>
                    <ul style={{ paddingLeft: '1rem', color: 'white', opacity: 0.8 }}>
                      <li>Minimal administrative overhead</li>
                      <li>Real-time expense reimbursements</li>
                      <li>Enhanced policy compliance</li>
                      <li>Complete expense visibility and control</li>
                    </ul>
                  </CardContent>
                </StyledCard>
              </Grid>
